...
|---|---|---|---|---|---|
| L120 | `content/assets/images/custom-compiler-te3.png` | No page | Preferences > C# Scripts and Macros with an empty custom compiler path and options | **To confirm:** the compiler pane appears to be removed or renamed | Delete the image if no page needs it |
